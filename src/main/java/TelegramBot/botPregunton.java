...
public class botPregunton extends TelegramLongPollingBot {
    ...
    public botPregunton() {
        ...
        preguntas.put("SECTION_4", new String[]{"Pregunta 4.1 - Eres gay?", "Pregunta 4.2 - Cuantos años tienes?", "Pregunta 4.3 - Por que eres gay?", "Pregunta 4.4 - Te gusta el anime?"});
        //validar si es un numero y que sea una edad valida
    }
    ...
    private void sendMenu(long chatId) {
        ...
        rows.add(crearFilaBoton("❤️Sección 4", "SECTION_4"));
